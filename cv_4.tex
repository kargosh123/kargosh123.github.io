...
%----------------------------------------------------------------------------------------
\begin{rSection}{Relevant College Courses}
\itab{\textbf{Core Courses}} \tab{}  \tab{\textbf{Future Fall Courses}}
...
\\ \itab{Introductory Physics \& Chemistry} \tab{} \tab{Discrete Mathematics}
\\ \itab{Introductory MATLAB \& Mathematica} \tab{} \tab{Introductory Political Science}

\end{rSection}

%----------------------------------------------------------------------------------------
\begin{rSection}{College Organizations} \itemsep -4pt
\item HackTech Organizer, Teaching Assistant for Introduction to Computer Science
\item Health Advocate, Board of Control Representative, Society of Women Engineers (SWE)
\end{rSection}
